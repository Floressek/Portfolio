...
const Homepage = () => {
    return <div className='h-full flex flex-col px-4 lg:flex-row sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl'>
        {/*IMAGE CONTAINER*/}
        {/*TODO: Add a rounded image of a programmer*/}
        <div className={`${styles.roundedImage} h-1/2 rounded-lg lg:h-full lg:w-1/2 lg:mr-8 relative overflow-hidden`}>
        ...
        <div className='h-1/2 lg:h-full lg:w-1/2 flex flex-col gap-8 text-center items-center justify-center'>
            {/*TITLE*/}
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-bold">Cooking Meth, Cooking Meth, Cooking Meth</h1>
            {/*DESCRIPTION*/}
